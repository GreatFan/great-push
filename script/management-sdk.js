...
var AccountManager = (function () {
        ...
        return Promise(function (resolve, reject, notify) {
            ...
            request.end(function (err, res) {
                ...
                if (err && status !== AccountManager.ERROR_UNAUTHORIZED) {
                    reject(_this.getGreatPushError(err, res));
                    return;
                }
    ...
    AccountManager.prototype.getGreatPushError = function (error, response) {
        if (error.syscall === "getaddrinfo") {
            error.message = "Unable to connect to the GreatPush server. Are you offline, or behind a firewall or proxy?\n(" + error.message + ")";
        }
        return {
    ...
    AccountManager.prototype.attachCredentials = function (request) {
        ...
        request.set("Accept", "application/vnd.great-push.v" + AccountManager.API_VERSION + "+json");
        request.set("Authorization", "Bearer " + this._accessKey);
        request.set("X-GreatPush-SDK-Version", packageJson.version);
    };
    ...
    AccountManager.SERVER_URL = "https://greatpush-management.azurewebsites.net";
